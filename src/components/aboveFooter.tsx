          ...
          >
            <div className="p-4 w-100">
              ...
              <div className="getintouch">
                ...
                <p>
                  <FaPhone size={20} color="black" /> Scarborough: 416 754 0347
                </p>
                <p>
                  <FaUserClock size={20} color="black" /> Monday to Friday:
                  11:00am to 6:30pm
                </p>
                <p style={{ color: "black", fontSize: "16px" }}>
                  {" "}
                  <CiBookmarkCheck size={20} color="black" /> Saturday: By
                  Appointment only
                </p>
                <p>
                  <FaMapLocation size={20} color="black" />
                  1825 MARKHAM ROAD, SUITE 203 SCARBOROUGH, ON, M1B 4Z9
                </p>
                <p></p>
                <div className="mt-3">
